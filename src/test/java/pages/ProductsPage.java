...
//    By shoppingCart = By.cssSelector(".shopping_cart_link.fa-layers.fa-fw");

    String productNameXpath = "//div[@class='inventory_item_name' and contains(text(),'$$')]";
    String productPriceXpath = "//div[text()='$$']/../../../div[3]/div";
    String productAddBtnXpath = "//div[text()='$$']/../../../div[3]/button[text()='ADD TO CART']";
    String productRemoveBtnXpath = "//div[text()='$$']/../../../div[3]/button[text()='REMOVE']";
